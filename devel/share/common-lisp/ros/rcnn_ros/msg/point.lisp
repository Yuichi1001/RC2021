...
(cl:defmethod cl:initialize-instance :after ((m <point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rcnn_ros-msg:<point> is deprecated: use rcnn_ros-msg:point instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rcnn_ros-msg:x-val is deprecated.  Use rcnn_ros-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rcnn_ros-msg:y-val is deprecated.  Use rcnn_ros-msg:y instead.")
  (y m))
